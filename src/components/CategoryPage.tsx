...
import SeminovosSection from './SeminovosSection';
...
const IMG_iPhone15_Rosa  = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone15rosa700x400.png';
const price_iPhone15_128GB_verde    = arredondarPreco(3939*1.01+50);
const IMG_iPhone15_Verde = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone15verde700x400.png';
const price_iPhone15_128GB_azul     = arredondarPreco(3939*1.01+50);
const IMG_iPhone15_Azul  = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone15azul700x400.png';
const price_iPhone15_128GB_preto    = arredondarPreco(3939*1.01+100);
const IMG_iPhone15_Preto = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone15preto700x400.png';

// ====== PREÇOS: iPhone 16e ======
const price_iPhone16e_128GB_preto   = arredondarPreco(3499*1.01+50);
const IMG_iPhone16e_Preto  = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16epreto1000x700.png';
const price_iPhone16e_128GB_branco  = arredondarPreco(3499*1.01+100);
const IMG_iPhone16e_Branco = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16ebranco1000x1000.png';

// ====== PREÇOS: iPhone 16 ======
const price_iPhone16_128GB_azul     = arredondarPreco(4499*1.01+50);
const IMG_iPhone16_Azul   = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16azul1000x700.png';
const price_iPhone16_128GB_preto    = arredondarPreco(4469*1.01+50);
const IMG_iPhone16_Preto  = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16preto1000x700.png';
const price_iPhone16_128GB_branco   = arredondarPreco(4469*1.01+100);
const IMG_iPhone16_Branco = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16branco1000x700.png';
...
const IMG_iPhone16Pro_Desert  = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16prodesert.png';
const price_iPhone16Pro_128GB_natural = arredondarPreco(5499*1.01+100);
const IMG_iPhone16Pro_Natural = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16pronatural.png';
const price_iPhone16Pro_128GB_branco  = arredondarPreco(5499*1.01+100);
const IMG_iPhone16Pro_Branco  = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16probranco.png';
const price_iPhone16Pro_128GB_preto   = arredondarPreco(5499*1.01+150);
const IMG_iPhone16Pro_Preto   = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16propreto.png';
...
const IMG_iPhone16ProMax_Desert  = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16promaxdesert.png';
const price_iPhone16ProMax_256GB_natural = arredondarPreco(6549*1.01+100);
const IMG_iPhone16ProMax_Natural = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16promaxnatural.png';
const price_iPhone16ProMax_256GB_branco  = arredondarPreco(6549*1.01+150);
const IMG_iPhone16ProMax_Branco  = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/iphone16promaxbranco.png';

// ====== PREÇOS: MAC / iPad / Acessórios ======

// ====== PREÇOS: Mac Mini M4 ======
const price_MacMiniM4_16GB_256GB_Prata = arredondarPreco(4450 * 1.01+50);
const IMG_MacMiniM4_16GB_256GB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macminim4.png';

// ====== PREÇOS: MacBook Air M3 ======
// 13"
const price_MacBookAirM3_13in_8GB_256GB_CinzaEspacial = arredondarPreco(6200 * 1.01+100);
const IMG_MacBookAirM3_13in_8GB_256GB_CinzaEspacial = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3spacegray.png';
const price_MacBookAirM3_13in_8GB_256GB_Midnight      = arredondarPreco(6200*1.01+150);
const IMG_MacBookAirM3_13in_8GB_256GB_Midnight = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3midnight.png';
const price_MacBookAirM3_13in_16GB_256GB_Prata        = arredondarPreco(6550 * 1.01 + 200);
const IMG_MacBookAirM3_13in_16GB_256GB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3prata.png';
const price_MacBookAirM3_13in_16GB_256GB_Midnight     = arredondarPreco(6550 * 1.01 + 200);
const IMG_MacBookAirM3_13in_16GB_256GB_Midnight = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3midnight.png';
const price_MacBookAirM3_13in_16GB_512GB_Estelar      = arredondarPreco(7550 * 1.01 + 200);
const IMG_MacBookAirM3_13in_16GB_512GB_Estelar = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3estelar.png';
// 15"
const price_MacBookAirM3_15in_16GB_512GB_Midnight     = arredondarPreco(9899);
const IMG_MacBookAirM3_15in_16GB_512GB_Midnight = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3midnight.png';

// ====== PREÇOS: MacBook Air M4 ======
// 16GB/256GB
const price_MacBookAirM4_16GB_256GB_SkyBlue  = arredondarPreco(6599*1.01+100);
const IMG_MacBookAirM4_16GB_256GB_SkyBlue = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm4skyblue.png';
const price_MacBookAirM4_16GB_256GB_Estelar  = arredondarPreco(6600 * 1.01+100);
const IMG_MacBookAirM4_16GB_256GB_Estelar = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3estelar.png';
const price_MacBookAirM4_16GB_256GB_Prata    = arredondarPreco(6600 * 1.01+100);
const IMG_MacBookAirM4_16GB_256GB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3prata.png';
const price_MacBookAirM4_16GB_256GB_Midnight = arredondarPreco(6600 * 1.01+150);
const IMG_MacBookAirM4_16GB_256GB_Midnight = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3midnight.png';
...
const IMG_MacBookAirM4_16GB_512GB_SkyBlue = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm4skyblue.png';
const price_MacBookAirM4_16GB_512GB_Estelar  = arredondarPreco(8850 * 1.01+300);
const IMG_MacBookAirM4_16GB_512GB_Estelar = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3estelar.png';
const price_MacBookAirM4_16GB_512GB_Midnight  = arredondarPreco(8850 * 1.01+300);
const IMG_MacBookAirM4_16GB_512GB_Midnight = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3midnight.png';
// 24GB/512GB
const price_MacBookAirM4_24GB_512GB_SkyBlue  = arredondarPreco(12799*1.01+600);
const IMG_MacBookAirM4_24GB_512GB_SkyBlue = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm4skyblue.png';
const price_MacBookAirM4_24GB_512GB_Estelar  = arredondarPreco(12799*1.01+600);
const IMG_MacBookAirM4_24GB_512GB_Estelar = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3estelar.png';
const price_MacBookAirM4_24GB_512GB_Prata    = arredondarPreco(12799*1.01+600);
const IMG_MacBookAirM4_24GB_512GB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3prata.png';
const price_MacBookAirM4_24GB_512GB_Midnight = arredondarPreco(12799*1.01+600);
const IMG_MacBookAirM4_24GB_512GB_Midnight = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookairm3midnight.png';

// ====== PREÇOS: MacBook Pro M4 ======
// 14" + M4
const price_MacBookProM4_14in_M4_16GB_512GB_PretoEspacial = arredondarPreco(11000*1.01+500);
const IMG_MacBookProM4_14in_M4_16GB_512GB_PretoEspacial = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4blackspace.png';
const price_MacBookProM4_14in_M4_16GB_512GB_Prata         = arredondarPreco(11000*1.01+600);
const IMG_MacBookProM4_14in_M4_16GB_512GB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4silver.png';
const price_MacBookProM4_14in_M4_24GB_1TB_PretoEspacial   = arredondarPreco(15000*1.01+600);
const IMG_MacBookProM4_14in_M4_24GB_1TB_PretoEspacial = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4blackspace.png';
const price_MacBookProM4_14in_M4_24GB_1TB_Prata           = arredondarPreco(15000*1.01+700);
const IMG_MacBookProM4_14in_M4_24GB_1TB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4silver.png';
// 16" + M4
const price_MacBookProM4_16in_M4_48GB_512GB_PretoEspacial = arredondarPreco(21500*1.01+800);
const IMG_MacBookProM4_16in_M4_48GB_512GB_PretoEspacial = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4blackspace.png';
const price_MacBookProM4_16in_M4_48GB_512GB_Prata         = arredondarPreco(21500*1.01+900);
const IMG_MacBookProM4_16in_M4_48GB_512GB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4silver.png';
// 14" + M4 Pro
const price_MacBookProM4_14in_M4Pro_24GB_512GB_PretoEspacial = arredondarPreco(13600*1.01+800);
const IMG_MacBookProM4_14in_M4Pro_24GB_512GB_PretoEspacial = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4blackspace.png';
const price_MacBookProM4_14in_M4Pro_24GB_512GB_Prata         = arredondarPreco(13600*1.01+900);
const IMG_MacBookProM4_14in_M4Pro_24GB_512GB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4silver.png';
// 16" + M4 Pro
const price_MacBookProM4_16in_M4Pro_24GB_512GB_PretoEspacial = arredondarPreco(17500*1.01+1000);
const IMG_MacBookProM4_16in_M4Pro_24GB_512GB_PretoEspacial = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4blackspace.png';
const price_MacBookProM4_16in_M4Pro_24GB_512GB_Prata         = arredondarPreco(17500*1.01+1100);
const IMG_MacBookProM4_16in_M4Pro_24GB_512GB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4silver.png';
// 14" + M4 Max
const price_MacBookProM4_14in_M4Max_36GB_1TB_PretoEspacial = arredondarPreco(23000*1.01+2000);
const IMG_MacBookProM4_14in_M4Max_36GB_1TB_PretoEspacial = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4blackspace.png';
const price_MacBookProM4_14in_M4Max_36GB_1TB_Prata         = arredondarPreco(23000*1.01+2300);
const IMG_MacBookProM4_14in_M4Max_36GB_1TB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4silver.png';
// 16" + M4 Max
const price_MacBookProM4_16in_M4Max_36GB_1TB_PretoEspacial = arredondarPreco(24500*1.01+2500);
const IMG_MacBookProM4_16in_M4Max_36GB_1TB_PretoEspacial = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4blackspace.png';
const price_MacBookProM4_16in_M4Max_36GB_1TB_Prata         = arredondarPreco(24500*1.01+2600);
const IMG_MacBookProM4_16in_M4Max_36GB_1TB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4silver.png';
const price_MacBookProM4_16in_M4Max_48GB_1TB_PretoEspacial = arredondarPreco(28900*1.01+3000);
const IMG_MacBookProM4_16in_M4Max_48GB_1TB_PretoEspacial = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4blackspace.png';
const price_MacBookProM4_16in_M4Max_48GB_1TB_Prata         = arredondarPreco(28900*1.01+3200);
const IMG_MacBookProM4_16in_M4Max_48GB_1TB_Prata = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4silver.png';
...
const IMAGE_MACBOOK_PRO_M4_MAX_16_128GB_2TB_SPACE_BLACK = "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4max16-128-2tb-black.png";
const IMAGE_MACBOOK_PRO_M4_MAX_16_128GB_2TB_SILVER = "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/macbookprom4max16-128-2tb-silver.png";

// IPAD 11 — preços por armazenamento e cor
// imagens por cor
const IMG_iPad11_Blue = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/ipad11azul.png';
const IMG_iPad11_Pink = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/ipad11rosa.png';
const IMG_iPad11_Silver = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/ipad11silver.png';

// iPad Air — imagens por cor
const IMG_iPadAir_SpaceGray = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/ipadairspacegray.png';
const IMG_iPadAir_Estelar   = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/ipadairestelar.png';
const IMG_iPadAir_Azul      = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/ipadairazul.png';
const IMG_iPadAir_Roxo      = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/ipadairroxo.png';
// iPad Pro — imagens por cor
const IMG_iPadPro_SpaceGray = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/ipadprospacegray.png';
const IMG_iPadPro_Prata     = 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/ipadprosilver.png';
...
const IMG_AppleWatchSE_40mm = 'https://images.pexels.com/photos/437037/pexels-photo-437037.jpeg?auto=compress&cs=tinysrgb&w=1200';
const price_AppleWatchSE_44mm = arredondarPreco(3299);
const IMG_AppleWatchSE_44mm = 'https://images.pexels.com/photos/437037/pexels-photo-437037.jpeg?auto=compress&cs=tinysrgb&w=1200';
const price_AppleWatchSeries10_42mm = arredondarPreco(4999);
const IMG_AppleWatchSeries10_42mm = 'https://images.pexels.com/photos/437037/pexels-photo-437037.jpeg?auto=compress&cs=tinysrgb&w=1200';
const price_AppleWatchSeries10_46mm = arredondarPreco(5399);
const IMG_AppleWatchSeries10_46mm = 'https://images.pexels.com/photos/437037/pexels-photo-437037.jpeg?auto=compress&cs=tinysrgb&w=1200';
...
const IMG_AppleWatchUltra2_49mm = 'https://images.pexels.com/photos/437037/pexels-photo-437037.jpeg?auto=compress&cs=tinysrgb&w=1200';
...
const IMG_AirPods4 = "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/airpods4.png";
const price_AirPods4_NC = calculatePrice(AIRPODS4_NC_COST);
const IMG_AirPods4_NC = "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/airpods4.png";
const price_AirPodsPro2 = calculatePrice(AIRPODS_PRO2_COST);
const IMG_AirPodsPro2 = "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/airpodspro.png";
const price_AirPodsMax  = calculatePrice(AIRPODS_MAX_COST, 300);
const IMG_AirPodsMax = "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/airpodsmaxpreto.png";
...
const CategoryPage: React.FC<CategoryPageProps> = ({ category, onBack, onCategorySelect }) => {
  const [selectedProducts, setSelectedProducts] = useState<{[key: string]: { screen?: string; storage: string; color: string; chip?: string }}>({});
      ...
      products: [
        {
          ...
          colorOptions: [
            { name: 'Prata', image: IMG_MacMiniM4_16GB_256GB_Prata, hex: '#C0C0C0' }
          ],
        ...
        },
        {
          ...
          colorOptions: [
            { name: 'Cinza Espacial', image: IMG_MacBookAirM3_13in_8GB_256GB_CinzaEspacial, hex: '#8E8E93' },
        ...
        },
        {
          ...
          colorOptions: [
            { name: 'Preto Espacial', image: IMG_MacBookProM4_14in_M4_16GB_512GB_PretoEspacial, hex: '#2C2C2C' },
      ...
      products: [
          ...
          colorOptions: [
            {
              name: "Midnight",
              hex: "#1c1c1e",
              image: "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/watchsemidnight.png"
            },
            {
              name: "Silver",
              hex: "#d8d8d8",
              image: "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/watchsesilver.png"
            },
            {
              name: "Estelar",
              hex: "#f5deb3",
              image: "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/watchseestelar.png"
            }
          ],
          connectivityOptions: [
            { type: 'GPS', price: 0 },
        ...
        },
        {
          ...
          modeloOptions: [
            ...
            { modelo: 'AirPods 4 Noise Cancellation', price: calculatePrice(AIRPODS4_NC_COST), image: IMG_AirPods4_NC },
            { modelo: 'Airpods Pro 2', price: calculatePrice(AIRPODS_PRO2_COST), image: IMG_AirPodsPro2 },
            { modelo: 'AirPods Max', price: calculatePrice(AIRPODS_MAX_COST, 300), image: IMG_AirPodsMax },
          ],
          storageOptions: [
            { size: 'Padrão', price: 0 }
          ],
          ...
          colorOptions: [
            { name: 'Branco', image: "https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/airpods4.png", hex: '#FFFFFF' }
          ],
        ...
        },
        {
          ...
          modeloOptions: [
            { modelo: 'Apple Pencil 2', price: price_ApplePencil2, image: 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/pencil2.png' },
            { modelo: 'Apple Pencil USB-C', price: price_ApplePencilUSBC, image: 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/pencilusbc.png' },
            { modelo: 'Apple Pencil Pro', price: price_ApplePencilPro, image: 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/pencilpro.png' },
          ],
          storageOptions: [
            { size: 'Padrão', price: 0 }
          ],
          colorOptions: [
            { name: 'Branco', image: 'https://images.pexels.com/photos/270404/pexels-photo-270404.jpeg?auto=compress&cs=tinysrgb&w=1200', hex: '#FFFFFF' }
          ],
  ...
  const handleStorageChange = (productId: string, storage: string) => {
    ...
    let newChip = selectedProducts[productId]?.chip || (product.chipOptions ? product.chipOptions[0].name : undefined);
    let newScreen = selectedProducts[productId]?.screen || (product.screenOptions ? product.screenOptions[0].size : undefined);
    ...
    const getAvailableColors = (productId: string, storage: string, screen?: string) => {
      ...
      if (productId === 'macbook-air-m3') {
        ...
        if (selectedScreen === '13"') {
          if (storage === '8GB/256GB') {
            return product.colorOptions.filter(c => c.name === 'Cinza Espacial' || c.name === 'Midnight');
      ...
      if (productId === 'macbook-air-m4') {
        const selectedScreen = screen || (product.screenOptions ? product.screenOptions[0].size : '13"');
    ...
    if (productId === 'iphone-16-pro' && storage === '256GB' && newColor !== 'Desert' && newColor !== 'Branco') {
      newColor = 'Desert';
    }
  ...
  const handleColorChange = (productId: string, color: string) => {
    ...
    let newChip = currentSelected.chip || (product.chipOptions ? product.chipOptions[0].name : undefined);
    let newScreen = currentSelected.screen || (product.screenOptions ? product.screenOptions[0].size : undefined);
  ...
  const getProductPrice = (product: Product, productId: string) => {
    ...
    const selectedScreen = selected?.screen || (product.screenOptions ? product.screenOptions[0].size : undefined);
    const selectedChip = selected?.chip || (product.chipOptions ? product.chipOptions[0].name : undefined);
    ...
    switch (productId) {
      ...
      case 'macbook-air-m3': {
        if (selectedScreen === '15"' && selectedStorage === '16GB/512GB' && selectedColor === 'Midnight') {
          return price_MacBookAirM3_15in_16GB_512GB_Midnight;
        }
        if (selectedScreen === '13"' && selectedStorage === '8GB/256GB') {
          if (selectedColor === 'Cinza Espacial') return price_MacBookAirM3_13in_8GB_256GB_CinzaEspacial;
        ...
        if (selectedScreen === '13"' && selectedStorage === '16GB/512GB' && selectedColor === 'Estelar') {
      ...
      case 'macbook-pro-m4': {
        if (selectedScreen === '14"' && selectedChip === 'M4') {
          if (selectedStorage === '16GB/512GB') {
            if (selectedColor === 'Preto Espacial') return price_MacBookProM4_14in_M4_16GB_512GB_PretoEspacial;
            if (selectedColor === 'Prata')         return price_MacBookProM4_14in_M4_16GB_512GB_Prata;
          }
          if (selectedStorage === '24GB/1TB') {
            if (selectedColor === 'Preto Espacial') return price_MacBookProM4_14in_M4_24GB_1TB_PretoEspacial;
        ...
        if (selectedScreen === '16"' && selectedChip === 'M4' && selectedStorage === '48GB/512GB') {
          if (selectedColor === 'Preto Espacial') return price_MacBookProM4_16in_M4_48GB_512GB_PretoEspacial;
          if (selectedColor === 'Prata')         return price_MacBookProM4_16in_M4_48GB_512GB_Prata;
        }
        if (selectedScreen === '14"' && selectedChip === 'M4 Pro' && selectedStorage === '24GB/512GB') {
          if (selectedColor === 'Preto Espacial') return price_MacBookProM4_14in_M4Pro_24GB_512GB_PretoEspacial;
          if (selectedColor === 'Prata')         return price_MacBookProM4_14in_M4Pro_24GB_512GB_Prata;
        }
        if (selectedScreen === '16"' && selectedChip === 'M4 Pro' && selectedStorage === '24GB/512GB') {
          if (selectedColor === 'Preto Espacial') return price_MacBookProM4_16in_M4Pro_24GB_512GB_PretoEspacial;
          if (selectedColor === 'Prata')         return price_MacBookProM4_16in_M4Pro_24GB_512GB_Prata;
        }
        if (selectedScreen === '14"' && selectedChip === 'M4 Max' && selectedStorage === '36GB/1TB') {
          if (selectedColor === 'Preto Espacial') return price_MacBookProM4_14in_M4Max_36GB_1TB_PretoEspacial;
        ...
        if (selectedScreen === '16"' && selectedChip === 'M4 Max') {
          if (selectedStorage === '36GB/1TB') {
            if (selectedColor === 'Preto Espacial') return price_MacBookProM4_16in_M4Max_36GB_1TB_PretoEspacial;
            if (selectedColor === 'Prata')         return price_MacBookProM4_16in_M4Max_36GB_1TB_Prata;
          }
          if (selectedStorage === '48GB/1TB') {
            if (selectedColor === 'Preto Espacial') return price_MacBookProM4_16in_M4Max_48GB_1TB_PretoEspacial;
          ...
          if (selectedStorage === '128GB/2TB') {
            if (selectedColor === 'Preto Espacial') return PRICE_MACBOOK_PRO_M4_MAX_16_128GB_2TB_SPACE_BLACK;
    ...
    if (productId === 'macbook-pro-m4') {
      ...
      if (selectedScreen === '16"' && selectedChip === 'M4 Max' && selectedStorage === '128GB/2TB') {
        if (selectedColor === 'Preto Espacial') return IMAGE_MACBOOK_PRO_M4_MAX_16_128GB_2TB_SPACE_BLACK;
      ...
      case 'apple-watch': {
        ...
        if (model === 'SE (2nd Gen)') {
          if (size === '40mm') {
            ...
            if (color === 'Estelar' || color === 'Stellar' || color === 'Starlight') return price_AppleWatchSE_40mm_Estelar;
          }
          if (size === '44mm') {
            ...
            if (color === 'Estelar' || color === 'Stellar' || color === 'Starlight') return price_AppleWatchSE_44mm_Estelar;
          }
        }
      ...
      case 'airpods': {
        ...
        const modelo = sel.modelo || (product.modeloOptions ? product.modeloOptions[0].modelo : 'AirPods 4');
      ...
      case 'apple-pencil': {
        const sel = selectedProducts[productId] || {};
        const modelo = sel.modelo || (product.modeloOptions ? product.modeloOptions[0].modelo : 'Apple Pencil 2');
    ...
    const storageOption = product.storageOptions.find(opt => opt.size === selectedStorage) || product.storageOptions[0];
    const chipOption = product.chipOptions?.find(opt => opt.name === selectedChip) || (product.chipOptions ? product.chipOptions[0] : { price: 0 });
    const screenOption = product.screenOptions?.find(opt => opt.size === selectedScreen) || (product.screenOptions ? product.screenOptions[0] : { price: 0 });
  ...
  const getProductImage = (product: Product, productId: string) => {
    ...
    if (productId === 'apple-watch') {
      ...
      if (model === 'Series 10') {
        if (color === 'Rosa')      return 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/watch10rosa.png';
        if (color === 'Silver')    return 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/watch10silver.png';
        if (color === 'Jet Black') return 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/watch10jetblack.png';
      }
      ...
      if (model === 'SE (2nd Gen)') {
        if (color === 'Midnight')           return 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/watchsemidnight.png';
        if (color === 'Prata' || color === 'Silver') return 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/watchsesilver.png';
      }
    }
    // Apple Pencil: imagem por modelo
    if (productId === 'apple-pencil') {
      const sel = selectedProducts[productId] || {};
      const modelo = sel.modelo || (product.modeloOptions ? product.modeloOptions[0].modelo : undefined);
      if (modelo === 'Apple Pencil 2')      return 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/pencil2.png';
      if (modelo === 'Apple Pencil USB-C')  return 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/pencilusbc.png';
      if (modelo === 'Apple Pencil Pro')    return 'https://raw.githubusercontent.com/cloudracdev/images-site-infinite-core-products/refs/heads/main/pencilpro.png';
    }
    ...
    const selected = selectedProducts[productId];
    const colorOption = product.colorOptions.find(opt => opt.name === selected?.color) || product.colorOptions[0];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-center mb-6 sm:mb-8">
          <button
            onClick={onBack}
            className="flex items-center text-gray-600 hover:text-black transition-colors duration-200 mr-6"
          >
        ...
        {/* Products Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8 animate-fadeInUp">
          {currentCategory.products.map((product) => {
            ...
            const selected = selectedProducts[productId] || {
              ...
              color: product.colorOptions[0].name,
              chip: product.chipOptions ? product.chipOptions[0].name : undefined,
              tamanho: isAppleWatch ? getAppleWatchSizeOptions(product.storageOptions[0].size)[0] : undefined,
              modelo: isAirPods ? (product.modeloOptions ? product.modeloOptions[0].modelo : undefined) : undefined,
              connectivity: product.connectivityOptions ? product.connectivityOptions[0].type : undefined,
            };
            const isOut = 
              (product.available === false)
              || (productId === 'macbook-air-m3' && (selected.screen || (product.screenOptions ? product.screenOptions[0].size : '13"')) === '15"' && (selected.storage || product.storageOptions[0].size) === '16GB/512GB');
            ...
            return (
              <div key={productId} className={`bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-500 flex flex-col ${isOut ? 'opacity-60' : 'hover:shadow-xl hover:-translate-y-1 animate-fadeInUp'}`}>
                {/* Product Image */}
                <div className="relative aspect-[5/4] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                  {isOut && (
                    <div className="absolute top-2 left-2 z-10 px-2 py-1 text-[10px] font-semibold uppercase tracking-wide bg-black text-white rounded">
                      ESGOTADO
                    </div>
                  )}
                  <img
                    ...
                    alt={product.name}
                    className={`w-full h-full object-cover transition-all duration-500 ${isOut ? 'grayscale' : 'hover:scale-105'}`}
                  />
                </div>
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  {product.screenOptions && (
                    <div className="mb-3">
                      <h4 className="text-xs font-medium text-gray-700 mb-1">Tela</h4>
                      <div className="flex flex-wrap gap-1">
                        {product.screenOptions.map((option) => (
                          <button
                            key={option.size}
                            onClick={() => handleScreenChange(productId, option.size)}
                            className={`px-2 py-1 rounded-md border transition-all duration-200 text-xs ${
                  ...
                  {product.chipOptions && (
                    <div className="mb-3">
                      <h4 className="text-xs font-medium text-gray-700 mb-1">Chip</h4>
                      <div className="flex flex-wrap gap-1">
                  ...
                  {productId === 'apple-pencil' ? (
                    <div className="mb-3">
                      <h4 className="text-xs font-medium text-gray-700 mb-1">Modelo</h4>
                      <div className="flex flex-wrap gap-1">
                            ...
                            onClick={() => {
                              setSelectedProducts(prev => ({
                                ...
                                [productId]: {
                                  ...
                                  color: selected.color || (product.colorOptions[0]?.name || 'Branco'),
                                }
                              }));
                            }}
                            className={`px-2 py-1 rounded-md border transition-all duration-200 text-xs ${
                              (selected.modelo || product.modeloOptions[0].modelo) === option.modelo
                                ? 'border-black bg-black text-white'
                                : 'border-gray-300 hover:border-gray-400'
                            }`}
                          >
                      ...
                      <div className="flex flex-wrap gap-1">
                        {product.storageOptions
                          .filter((option) => {
                            ...
                            const selectedScreen = selected.screen || (product.screenOptions ? product.screenOptions[0].size : '13"');
            ...
            if (selectedScreen === '16"' && selectedChip === 'M4 Max') {
              return option.size === '36GB/1TB' || option.size === '48GB/1TB' || option.size === '128GB/2TB';
            }
...
// }
                          ...
                          .map((option) => (
                            <button
                              ...
                              className={`px-2 py-1 rounded-md border transition-all duration-200 text-xs ${
                                (selected.storage || product.storageOptions[0].size) === option.size
                                  ? 'border-black bg-black text-white'
                                  : 'border-gray-300 hover:border-gray-400'
                              }`}
                            >
                  ...
                  {isAppleWatch && (
                    <div className="mb-3">
                      <h4 className="text-xs font-medium text-gray-700 mb-1">Tamanho</h4>
                      <div className="flex flex-wrap gap-1">
                  ...
                  {/* Color Options */}
                  <div className="mb-3">
                    <h4 className="text-xs font-medium text-gray-700 mb-1">Cor</h4>
                    <div className="flex flex-wrap gap-1.5">
                      {(function() {
                        // MACBOOK AIR M4 (15" + 16/256): só Sky Blue e Midnight
                        if (product.id === 'macbook-air-m4') {
                          const selScreen = selected.screen || (product.screenOptions ? product.screenOptions[0].size : '13"');
                          ...
                          if (selScreen === '15"' && selStorage === '16GB/256GB') {
                            ...
                            return allowed.map((opt) => (
                              <button
                                ...
                                className={`flex items-center space-x-1.5 px-2 py-1 rounded-md border transition-all duration-200 ${
                                  selected.color === opt.name ? 'border-black bg-gray-50' : 'border-gray-300 hover:border-gray-400'
                                }`}
                              >
                                <div className="w-2.5 h-2.5 rounded-full border border-gray-300" style={{ backgroundColor: opt.hex }} />
                        ...
                        if (isAppleWatch && selected.storage === 'Ultra 2') {
                          ...
                          return colors.map((colorName) => (
                            <button
                              ...
                              onClick={() => handleColorChange(productId, colorName)}
                              className={`flex items-center space-x-1.5 px-2 py-1 rounded-md border transition-all duration-200 ${
                                selected.color === colorName ? 'border-black bg-gray-50' : 'border-gray-300 hover:border-gray-400'
                              }`}
                            >
                              <div
                                className="w-2.5 h-2.5 rounded-full border border-gray-300"
                        ...
                        if (isAirPods) {
                          ...
                          const modeloSelecionado = selected.modelo || (product.modeloOptions && product.modeloOptions[0]?.modelo) || '';
                        ...
                        return product.colorOptions.filter((option) => {
                          ...
                          if (productId === 'macbook-air-m3') {
                            ...
                            if (selectedScreen === '13"') {
                              if (selectedStorage === '8GB/256GB') {
                                return option.name === 'Cinza Espacial' || option.name === 'Midnight';
                          ...
                          if (productId === 'macbook-air-m4') {
                            ...
                            if (selectedStorage === '16GB/512GB') {
                              ...
                              return option.name === 'Sky Blue' || option.name === 'Estelar' || option.name === 'Midnight';
                            }
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    <span className="text-lg font-semibold text-black">
                      {isOut ? '—' : (() => {
                        ...
                        if (isAirPods) {
                          const modeloSel = selected.modelo || (product.modeloOptions ? product.modeloOptions[0].modelo : undefined);
                          const found = product.modeloOptions?.find(opt => opt.modelo === modeloSel);
                    ...
                    {isOut && (
                      <span className="ml-2 text-[10px] font-medium text-red-600 uppercase">Indisponível no momento</span>
                    )}
                    <button
                      onClick={() => {
                        if (isOut) return;
                      ...
                      disabled={isOut}
                      className={`flex items-center px-3 py-1.5 rounded-full transition-colors duration-300 ${isOut ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-black text-white hover:bg-gray-900'}`}
                    >
                      <ShoppingBag className="w-3 h-3 mr-1.5" />
                      <span className="font-medium text-xs">Comprar</span>
                    </button>
                  </div>
                </div>
              </div>
        ...
        <div className="text-center mt-16 mb-8">
          <a
            ...
            className="text-black hover:text-gray-600 transition-colors duration-200 underline text-sm font-medium"
          >
        ...
        <div className="text-center mb-12">
          <p className="text-xs text-gray-500">
            Aparelhos lacrados têm 1 ano de garantia Apple. Produtos à vista para pagamento no PIX ou cartão de crédito parcelado.
          </p>
        </div>
